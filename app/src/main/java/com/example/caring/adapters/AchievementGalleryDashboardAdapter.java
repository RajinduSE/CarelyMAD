...
public class AchievementGalleryDashboardAdapter extends ArrayAdapter<String> {
    Context context;
    int[] images;
    String[] title;
    public AchievementGalleryDashboardAdapter(Context context, String[] title, int[] images){
